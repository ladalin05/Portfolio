...
export  const Hero = () => {
    ...
    return (
        <section className="relative min-h-screen flex items-center overflow-hidden py-22 transition-colors duration-700 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-200">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-8 w-full">
                <div className="grid lg:grid-cols-12 gap-12 items-center">
                    <div className="lg:col-span-8">
                        ...
                        <h1 className="font-display mb-8 transition-all duration-1000 delay-300 opacity-100">
                        ...
                        <p className="text-lg md:text-xl font-light leading-relaxed mb-12 max-w-2xl text-slate-600 dark:text-slate-400 transition-all duration-1000 delay-500 opacity-100 translate-y-0">
                        ...
                        <div className="flex flex-wrap items-center gap-6 transition-all duration-1000 delay-700 opacity-100">
                        ...
                        <div className="flex flex-wrap gap-12 md:gap-20 mt-20 transition-all duration-1000 delay-1000 opacity-100">
                    ...
                    <div className="hidden lg:block lg:col-span-4 relative">
                        <div className="relative w-full aspect-square transition-all duration-[2000ms] opacity-100 scale-100 rotate-0">
            ...
            <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4 transition-all duration-1000 delay-[1200ms]">
