                ...
                <div className="grid items-start gap-16 lg:grid-cols-12 lg:gap-24">
                    ...
                    <div className="reveal lg:col-span-7">
                        ...
                        <div className="mb-12 grid grid-cols-2 gap-4">
                            {
                                facts.map((fact, index) => (
                                    <div key={index} className="group rounded-2xl border border-slate-200 bg-white p-5 transition-all duration-300 hover:border-blue-500/40 hover:bg-blue-50 dark:border-white/5 dark:bg-blue-500/[0.02] dark:hover:bg-blue-500/[0.05]">
                        ...
                        <div className="flex items-center gap-8">
                            <a href="#" className="group relative inline-flex items-center gap-3 rounded-full bg-blue-600 px-8 py-4 font-mono text-xs font-bold uppercase tracking-widest text-white transition-all hover:bg-blue-700 hover:shadow-[0_0_30px_rgba(59,130,246,0.4)] dark:hover:bg-blue-500">
